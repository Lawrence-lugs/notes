...
::: {.callout-tip title="The Spectral Theorem"}
...
::: {.callout-tip title="For second-order FEM formulas"}
...
::: {.callout-note title="Effective Modal Inertia"}
